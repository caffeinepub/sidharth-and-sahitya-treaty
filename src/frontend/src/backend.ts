...
export class Backend implements backendInterface {
    ...
    async clearSignatures(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.clearSignatures();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSignatures(): Promise<Array<[string, string]>> {
        if (this.processError) {
            try {
    ...
    async signTreaty(arg0: string, arg1: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.signTreaty(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
